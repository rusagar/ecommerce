...
(function ($) {
	...
	function Wysiwyg() {
		...
		this.defaults = {
html: '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" style="margin: 0"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"/></head><body style="font-family: ProximaNova-Regular!important;color:#434343;font-size:12px;line-height:22px;background:none; width:724px; min-height:245px; ">INITIAL_CONTENT</body></html>',
			debug: false,
			controls: {},
			css: {},
			events: {},
