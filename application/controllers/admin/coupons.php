...
class Coupons extends Admin_Controller {	
	...
	function index()
	{
		$this->template->set('title', lang('coupons'));
		$data['coupons']	= $this->coupon_model->get_coupons();
		$this->template->load('templates/admin/brainlight', 'admin/coupons/index', $data);	
	}
	...
	function form($id = false)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
				...
				$this->template->load('templates/admin/brainlight', 'admin/coupons/coupon_form', $data);	
		}
		else
		{
			$save['id']						= $id;
