...
<div class="row">
	<div class="span8">
		...
		<div class="tab-content">
			<div class="tab-pane active" id="product_info">
				...
				<div class="row">
					<div class="span8">
						...
						<?php
						$data	= array('name'=>'description', 'class'=>'redactor', 'value'=>set_value('description', $description), 'rows'=>20);
			...
			<div class="tab-pane" id="product_categories">
				<div class="row">
					<div class="span8">
                                            <br><label><strong><?php echo lang('select_a_product');?></strong></label>
					</div>
				</div>
				<div class="row">
					<div class="span2" style="text-align:center">
						<div class="row">
							<div class="span2">
								...
								{
									$.post("<?php echo site_url('admin/categories/category_autocomplete/');?>", { name: $('#category_search').val(), limit:10},
										function(data) {
			...
			<div class="tab-pane" id="product_photos">
				<div class="row"><br>
					<iframe id="iframe_uploader" src="<?php echo site_url('admin/products/product_image_form');?>" class="span8" style="height:200px; border:0px;"></iframe>
				</div>
				<div class="row">
					<div class="span8">
	...
	<div class="span4">
		...
		echo form_dropdown('featured', $options, set_value('featured',$featured), 'class="span4"');
		?>
...
function add_image($photo_id, $filename, $alt, $caption, $primary=false)
{
	...
	ob_start();
	?>
	<div class="row gc_photo" id="gc_photo_<?php echo $photo_id;?>" style=" border-bottom:1px solid #ddd; padding-bottom:10px; margin-bottom:10px;">
		<div class="span2">
		...
		<div class="span6">
			<div class="row">
				...
				<div class="span2">
					<a onclick="return remove_image($(this));" rel="<?php echo $photo_id;?>" class="btn btn-danger" style="float:right; font-size:9px;"><i class="icon-trash icon-white"></i></a>
				</div>
			</div>
			<div class="row">
				<div class="span6">
	...
	return '
			<tr id="related_product_'.$id.'">
				<td>
					...
					'.$name.'</td>
				<td>
					<a class="btn btn-danger pull-right btn-mini" href="#" onclick="remove_related_product('.$id.'); return false;"><i class="icon-trash icon-white"></i></a>
				</td>
			</tr>
		';
}
	...
	return '
			<tr id="category_'.$id.'">
				<td>
					...
					'.$name.'</td>
				<td>
					<a class="btn btn-danger pull-right btn-mini" href="#" onclick="remove_category('.$id.'); return false;"><i class="icon-trash icon-white"></i></a>
				</td>
			</tr>
		';
}
